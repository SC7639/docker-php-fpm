...
RUN apt-get install -y php7.0-fpm php7.0-odbc php7.0-dev php7.0-mcrypt php7.0-mysql php7.0-sybase libmysqlclient-dev freetds-dev php7.0-odbc php7.0-curl
...
# Start php7-fpm service to create pid file needed to run php7-f,p
